...
pub fn generateJWT(allocator: std.mem.Allocator, app_id: []const u8, key_pem_path: []const u8, current_epoch_seconds: i64) ![]const u8 {
...
test "jwt: generateJWT" {
    ...
    const token = try generateJWT(std.testing.allocator, "404064", "src/demo_github_app/mizuochik-demo-github-app.2023-10-06.private-key.pem", epoch_sec_20230101T000000Z);
